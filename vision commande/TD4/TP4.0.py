...
def mask_func(color,c_min,c_max,image):
    ...
    for i in range(output[0]-1):
        cv2.putText(image, color, (int(output[3][i+1][0])-15,int(output[3][i+1][1])), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 0, 0), 1, cv2.LINE_AA)
        l = []
...
liste_couleur = [["Rouge",(119,120,150),(255,255,255)],["Bleu",(0,243,153),(20,255,255)],["Vert",(45,134,98),(54,255,191)],["Orange",(101,184,237),(255,255,255)],
                 ["Jaune",(73,226,220),(105,255,255)],["Blanc",(0,0,200),(255,128,255)]]
